...
(function(l) {
    ...
    u.defaults = {
        ...
        iStateDuration: 7200,
        iDeferLoading: null,
        iDisplayLength: 100, //  Сколько записей по дефолту
        iDisplayStart: 0,
        iTabIndex: 0,
        oClasses: {},
        oLanguage: {
            oAria: { sSortAscending: ": активировать для сортировки столбцов по возрастанию", sSortDescending: ": активировать для сортировки столбцов по убыванию" },
            oPaginate: { sFirst: "Первая", sLast: "Последняя", sNext: "След.", sPrevious: "Пред." },
            sEmptyTable: "<i>Данные в таблице <b>отсутствуют</b></i>",
            sInfo: "Показано с <b>_START_</b> до <b>_END_</b> из <b>_TOTAL_</b> записей",
            sInfoEmpty: "Показано с <b>0</b> до <b>0</b> из <b>0</b> записей",
            sInfoFiltered: "(всего <b>_MAX_</b> записей в таблице)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            ...
            sUrl: "",
            sZeroRecords: "<i>Записей по вашему запросу <b>не найдено</b></i>"
        },
