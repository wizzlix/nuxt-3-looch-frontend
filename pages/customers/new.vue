<template>
	<div>
		...
		<main class="container">
			...
			<UIModalWindow :modal-name="'заказчика'" v-show="showModal"  :on-click-save="save" :on-click-save-and-push="submit" :on-click-exit="exit"/>
			...
			<section class="form table-responsive">
				...
				<div class="input-group element">
					<span class="input-group-text" id="inputGroup-sizing-default">Название организации : </span>
